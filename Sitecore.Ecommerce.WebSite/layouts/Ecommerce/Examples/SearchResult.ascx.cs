// <copyright file="SearchResult.ascx.cs" company="Sitecore A/S">
...
namespace Sitecore.Ecommerce.layouts.Ecommerce
{
  ...
  public partial class SearchResult : UserControl
  {
    ...
    protected virtual Lucene.Net.Search.Query BuildQuery(string searchWords)
    {
      ...
      query.Add(new BooleanClause(new PrefixQuery(new Term(Sitecore.Search.BuiltinFields.Content, searchWords.ToLower())), BooleanClause.Occur.MUST));
      ...
      if (!string.IsNullOrEmpty(productRepository))
      {
        ...
        query.Add(new BooleanClause(new PrefixQuery(new Term(Sitecore.Search.BuiltinFields.Path, productRepository)), BooleanClause.Occur.MUST_NOT));
      }
