// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ShoppingCart.ascx.cs" company="Sitecore A/S">
...
namespace Sitecore.Ecommerce.layouts.Ecommerce.CheckOutProcess
{
  ...
  public partial class ShoppingCart : UserControl
  {
    ...
    /// The Shopping cart.
    /// </summary>
    private DomainModel.Carts.ShoppingCart shoppingCart;
    ...
    {
      get { return this.shoppingCart ?? Sitecore.Ecommerce.Context.Entity.GetInstance<DomainModel.Carts.ShoppingCart>(); }
    }
